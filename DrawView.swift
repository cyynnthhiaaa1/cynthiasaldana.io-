...
class DrawView: UIView{
    ...
    required init?(coder aDecoder: NSCoder){
        ...
        let tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(DrawView.doubleTap(_:)))
    ...
    func tap(_ gestureRecognizer: UIGestureRecognizer){
        ...
        if selectedLineIndex != nil{
            ...
            let targectRect = CGRect(x: point.x , y: point.y, width: 2, height: 2)
            menu.setTargetRect(targectRect, in: self)
